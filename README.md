...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0rjet-4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0rjet-4.containers.anotherwebservice.com/
...
```
git clone git@github.com:jarp0l/container-0rjet-4.git
cd container-0rjet-4
```
...
```
docker attach container-0rjet-4
```
